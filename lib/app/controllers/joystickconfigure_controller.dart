...
class JoystickConfigureController extends GetxController {
  //Keys
  ...
  void pressJoystickGamepad(String id, double joystickX, joystickY) async {
    ...
    if (hostConnect == "firebase") {
      // await db
      //     .collection(gamepadName)
      //     .doc('self')
      //     .update({'RightjoystickX': joystickX, 'RightjoystickY': joystickY});
    } else {
      socket!.emit("RightJoystick", {
        "joystickX": joystickX,
        "joystickY": joystickY,
        "gamepad": gamepadName
      });
