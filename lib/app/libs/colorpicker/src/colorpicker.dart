...
class ColorPicker extends StatefulWidget {
  ...
  final Widget Function(void Function()?, void Function()?, Color) widgetBtn;
          ...
          Column(
            children: <Widget>[
              ...
              Container(
                ...
                height: 100,
                child: Center(
                    child: widget.widgetBtn(
                        () {}, () {}, currentHsvColor.toColor())),
              ),
              colorHistory.isNotEmpty
                  ? SizedBox(
                      width: widget.colorPickerWidth,
                      height: 50,
                      child: ListView(
                          ...
                          children: <Widget>[
                            for (Color color in colorHistory)
                              Padding(
                                key: Key(color.hashCode.toString()),
                                padding:
                                    const EdgeInsets.fromLTRB(15, 18, 0, 0),
                                child: Center(
                                  child: GestureDetector(
