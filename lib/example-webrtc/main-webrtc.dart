...
class MainWebrtc extends StatefulWidget {
  @override
  _MainWebrtcState createState() => new _MainWebrtcState();
}
...
class _MainWebrtcState extends State<MainWebrtc> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      body: DataChannelSample(host: _server),
    ));
  }
