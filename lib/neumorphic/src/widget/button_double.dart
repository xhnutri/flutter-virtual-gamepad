...
typedef void NeumorphicButtonDoubleClickListener();
typedef void NeumorphicButtonDoubleEndClickListener();

/// A Neumorphic Button
///
/// When pressed, it will fire a call to its [NeumorphicButtonDoubleClickListener] click parameter
...
///
@immutable
class NeumorphicButtonDouble extends StatefulWidget {
  ...
  final Curve curve;
  final NeumorphicButtonDoubleClickListener? onPressed;
  final NeumorphicButtonDoubleEndClickListener? onEndPressed;
  ...
  @override
  _NeumorphicButtonDoubleState createState() => _NeumorphicButtonDoubleState();
}

class _NeumorphicButtonDoubleState extends State<NeumorphicButtonDouble> {
  ...
  @override
  void didUpdateWidget(NeumorphicButtonDouble oldWidget) {
  ...
  bool get clickableEnd {
    return widget.isEnabled && widget.onEndPressed != null;
  }
  ...
  double _getScale() {
    if (widget.pressed != null) {
      ...
      return widget.pressed!
          ? NeumorphicButtonDouble.PRESSED_SCALE
          : NeumorphicButtonDouble.UNPRESSED_SCALE;
    } else {
      return this.pressed
          ? NeumorphicButtonDouble.PRESSED_SCALE
          : NeumorphicButtonDouble.UNPRESSED_SCALE;
